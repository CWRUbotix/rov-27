...
```bash
python3 ~/depthai/calibrate.py -s 2.208 -nx 12 -ny 9 -brd ~/rov-27/src/surface/luxonis_cam/calibration/rov_depth_enclosure.json
```
...
```bash
python3 ~/depthai/calibrate.py -s 2.208 -nx 12 -ny 9 -brd ~/rov-27/src/surface/luxonis_cam/calibration/rov_depth_enclosure.json -m process
```
